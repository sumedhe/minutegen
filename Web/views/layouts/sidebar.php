<div id="sidebar" class="sidebar">
    <div id='matters-button' class='button sidebar-button'>
        <span><i class="material button size-18">question_answer</i></span>
        <span class='label'>Matters</span>
    </div>
    <div id='minutes-button' class='button sidebar-button'>
        <span><i class="material button size-18">description</i></span>
        <span class='label'>Minutes</span>
    </div>
    <div id='members-button' class='button sidebar-button'>
        <span><i class="material button size-18">account_circle</i></span>
        <span class='label'>Members</span>
    </div>
    <div id='help-button' class='button sidebar-button'>
        <span><i class="material button size-18">help</i></span>
